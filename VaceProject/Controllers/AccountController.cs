...
namespace VaceProject.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public Boolean isAdminUser(ApplicationUser signedInUser)
        {
            var s = UserManager.GetRoles(signedInUser.Id);
        ...
        [HttpPost]
        [AllowAnonymous]
        public async Task<JsonResult> SendRegEmail(RegisterViewModel model)
        {
            var recipientEmail = model.Email;

            try { 
                var MailHelper = new EmailHelper
                {
                    Sender = "hcoyle545@gmail.com", //email.Sender,
                    Recipient = recipientEmail,
                    RecipientCC = "coyle_h@hotmail.com",
                    Subject = "Welcome to VACE! Start here",
                    Body = "No period"
                };
